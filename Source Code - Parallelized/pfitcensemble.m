function obj = pfitcensemble(X,Y,varargin)
...
%                     (non-categorical) predictor, positive integer scalar.
%                     Set 'NumBins' to 50 to speed up training, usually
%                     with negligible loss of accuracy. Use 'NumBins' for
%                     ensembles of decision trees only. Default: []
...
%                      to STATSET. FITCENSEMBLE uses the following fields:
%                      'UseParallel'
%                      'UseSubstreams'
%                      'Streams'
...
%                     number of workers used by FITCENSEMBLE. If a parallel
